    ...
    <section
      ...
      <div className='container mx-auto'>
        ...
        <motion.p
          ...
          the competition. From the moment yoe engage with us, we strive to
          exceed your expectation inb every interaction.
        </motion.p>
        {/* car image */}
        <motion.div
        ...
        <motion.div
          ...
          <div className='flex flex-col items-center text-center max-w-[160px] xl:max-w-none p-2 xl:p-0'>
            ...
            <p className='hidden xl:flex'>
              ...
              experience with us is noting short of outstanding.
            </p>
          </div>
          {/* item 2 */}
          <div className='flex flex-col items-center text-center max-w-[160px] xl:max-w-none p-2 xl:p-0'>
